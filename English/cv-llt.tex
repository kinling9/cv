...
%% Photo is only shown if "fullonly" is included AND photo.jpg is present.
%% photo.jpg is gitignored, so a fresh clone still compiles -- just without it.
\IfFileExists{photo.jpg}{\includecomment{fullonly}}{\excludecomment{fullonly}}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


%% Private contact details. personal.tex holds the real values and is
%% gitignored; personal-example.tex is the committed template.
\IfFileExists{personal.tex}{\input{personal}}{\input{personal-example}}

\leftheader{%
  {\LARGE\bfseries\sffamily Min Wei}

  % Phone number and WeChat ID live in personal.tex (gitignored).
  % Each field is omitted entirely when its value is empty.
  \ifdefempty{\cvphone}{}{\makefield{\faPhone}{\texttt{\cvphone}}}
  \ifdefempty{\cvwechat}{}{\makefield{\faWeixin}{\cvwechat}}
  %% Next line
  % \makefield{\faGlobe}{\url{http://example.example.org/}}
  % You can use a tabular here if you want to line up the fields.
  \makefield{\faGithub}
  {\href{https://github.com/kinling9}{\texttt{kinling9}}}


  \makefield{\faEnvelope[regular]}{\href{mailto:vmin6810@gmail.com}{\texttt{vmin6810@gmail.com}}}
  ...
  % {\href{http://www.linkedin.com/in/min-wei-763588345/}{\texttt{Min Wei}}}
